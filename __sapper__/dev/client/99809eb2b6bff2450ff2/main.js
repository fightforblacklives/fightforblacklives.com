...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "99809eb2b6bff2450ff2";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div0, "class", "flex flex-col text-center sm:text-right sm:justify-end\n          sm:flex-row sm:flex-wrap org-list svelte-8x8zjc");
